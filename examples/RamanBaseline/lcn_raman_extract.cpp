...
static constexpr const char* kOutDir = "C:/HypercubeLCN/RamanModels/extracted";
...
int main()
{
    ...
    try
    {
        ...
        BaselineExtractor ex(MakeCoreConfig(), MakeTrainConfig());
        ...
        std::printf("lcn_raman_extract: extracted n=%zu stem=%s -> %s\n",
    ...
    {
        std::fprintf(stderr, "lcn_raman_extract: %s\n", e.what());
    }
    return exit_code;
}
